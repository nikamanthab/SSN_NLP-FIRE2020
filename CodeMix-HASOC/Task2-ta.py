'''
Runs for CodeMix HASOC task2 tamil
...
'''
train = pd.read_csv('../data/Tamil-Codemixed_offensive_data_Training-Tweet-HL.csv', names=['ID','Tweets', 'Labels'])
test = pd.read_csv('../HASOC-Dravidian-CodeMix/Task2/Tamil_hasoc_tanglish_test_without_labels (1).tsv','\t', names=['ID','Tweets'])
